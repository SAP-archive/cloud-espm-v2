...
sap.ui.define([
	...
	return Controller.extend("com.sap.espm.shop.controller.SalesOrder", {
						...
						press: function () {
							...
							if(emailId){
								$.ajax({
						            ...
						            dataType: "json",
						            url: "/ESPM/espm-cloud-web/espm.svc/GetSalesOrderInvoiceByEmail?EmailAddress='"+ emailId +"'&$expand=SalesOrderItems,Customer&$format=json",
		...
		handleListItemPress: function(event){
			...
			pdfURL = "/ESPM/espm-cloud-web/CmisRead?objectId="+event.getSource().getBindingContext().getObject("InvoiceLink");
