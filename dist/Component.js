sap.ui.define([
	...
	return UIComponent.extend("com.sap.espm.shop.Component", {
		...
		init: function() {
			...
			var oEspmModel = new sap.ui.model.odata.ODataModel(sServiceUrl, {
				json: true,
			...
			var sRootPath = jQuery.sap.getModulePath("com.sap.espm.shop");
			var sImagePath = sRootPath + "/Images";
			var imageModel = new sap.ui.model.json.JSONModel({
				path: sImagePath
			});
			this.setModel(imageModel, "sImagePath");
		},
